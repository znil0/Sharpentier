...
public class GestionCepaBacteriana extends javax.swing.JFrame {

    public GestionCepaBacteriana() {
        initComponents();
        setLocationRelativeTo(null); //Centrar
        jtCepasBacterianas.setModel(new CepaBacteriana().generateDTModelTemplate());
    ...
    private void initComponents() {
        ...
        jtCepasBacterianas = new javax.swing.JTable();
        btnAddCepaBacteriana = new javax.swing.JButton();
        lbFecha = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Sharpentier | Gestión de Cepas Bacterianas");
        ...
        btnGestionCepaBacteriana.setForeground(new java.awt.Color(160, 86, 233));
        ...
        btnGestionCultivo.setForeground(new java.awt.Color(246, 241, 251));
        ...
        jLabel1.setText("CEPAS BACTERIANAS");
        ...
        jtCepasBacterianas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtCepasBacterianas);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 670, 400));

        btnAddCepaBacteriana.setText("Añadir Cepa");
        btnAddCepaBacteriana.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddCepaBacterianaActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddCepaBacteriana, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 120, -1));
    ...
    // EVENT LISTENERS ---------------------------------------------------------
    private void btnAddCepaBacterianaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCepaBacterianaActionPerformed
        Instanciador objInst = new Instanciador();
        
        int cantObj = Integer.parseInt(showInputDialog("¿Cuántas Cepas Bacterianas desea añadir?"));
        
        CepaBacteriana[] arrayCepaBacteriana = new CepaBacteriana[cantObj];
        
        for(int i = 0; i < cantObj; i++){
            arrayCepaBacteriana[i] = objInst.instanciarCepaBacteriana(i+1);
        }
        
        DefaultTableModel modelo = new CepaBacteriana().generateDTModelTemplate();
        
        for(int i = 0; i < cantObj; i++){
            modelo.addRow(new Object[]{
                arrayCepaBacteriana[i].getIdBacteria(),
                arrayCepaBacteriana[i].getNombreBacteria(),
                arrayCepaBacteriana[i].getTemperatura(),
                arrayCepaBacteriana[i].getHumedad(),
                arrayCepaBacteriana[i].getTiempoIncubacion(),
                arrayCepaBacteriana[i].getMorfologiaColonial(),
                arrayCepaBacteriana[i].getTasaCrecimiento(),
                arrayCepaBacteriana[i].getDensidadOptica(),
            });
        }
        
        jtCepasBacterianas.setModel(modelo);
    }//GEN-LAST:event_btnAddCepaBacterianaActionPerformed

    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionCepaBacteriana().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAddCepaBacteriana;
    ...
    private javax.swing.JTable jtCepasBacterianas;
