...
public class GestionEmpleado extends javax.swing.JFrame {
    ...
    public GestionEmpleado() {
        ...
        jtEmpleados.setModel(new Empleado().generateDTModelTemplate());
    ...
    private void initComponents() {
        ...
        btnGestionEmpleado.setForeground(new java.awt.Color(160, 86, 233));
        ...
        btnAddEmpleados.setText("Añadir Empleados");
        btnAddEmpleados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddEmpleadosActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddEmpleados, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 160, -1));
    ...
    private void btnAddEmpleadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmpleadosActionPerformed
        ...
        int cantObj = Integer.parseInt(showInputDialog("¿Cuántos Empleados desea añadir?"));

        Empleado[] arrayEmpleado = new Empleado[cantObj];

        for(int i = 0; i < cantObj; i++){
            arrayEmpleado[i] = objInst.instanciarEmpleado(i+1);
        }

        DefaultTableModel modelo = new Empleado().generateDTModelTemplate();

        for(int i = 0; i < cantObj; i++){
            modelo.addRow(new Object[]{
                arrayEmpleado[i].getIdEmpleado(),
                arrayEmpleado[i].getNombre(),
                arrayEmpleado[i].getCedulaProfesional(),
                arrayEmpleado[i].getCURP(),
                arrayEmpleado[i].getRFC()
            });
        }
