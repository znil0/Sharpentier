...
public class GestionBiorreactor extends javax.swing.JFrame {

    public GestionBiorreactor() {
        initComponents();
        setLocationRelativeTo(null); //Centrar
        jtBiorreactores.setModel(new Biorreactor().generateDTModelTemplate());
    ...
    private void initComponents() {
        ...
        jtBiorreactores = new javax.swing.JTable();
        btnAddBiorreactor = new javax.swing.JButton();
        ...
        btnGestionBiorreactor.setForeground(new java.awt.Color(160, 86, 233));
        ...
        jtBiorreactores.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtBiorreactores);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 670, 400));

        btnAddBiorreactor.setText("Añadir Biorreactor");
        btnAddBiorreactor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddBiorreactorActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddBiorreactor, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 150, -1));
    ...
    private void btnAddBiorreactorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddBiorreactorActionPerformed
        Instanciador objInst = new Instanciador();

        int cantObj = Integer.parseInt(showInputDialog("¿Cuántos Biorreactores desea añadir?"));

        Biorreactor[] arrayBiorreactor = new Biorreactor[cantObj];

        for(int i = 0; i < cantObj; i++){
            arrayBiorreactor[i] = objInst.instanciarBiorreactor(i+1);
        }

        DefaultTableModel modelo = new Biorreactor().generateDTModelTemplate();

        for(int i = 0; i < cantObj; i++){
            modelo.addRow(new Object[]{
                arrayBiorreactor[i].getIdBiorreactor(),
                arrayBiorreactor[i].getNombre(),
                arrayBiorreactor[i].getTipo(),
                arrayBiorreactor[i].getCapacidad(),
                arrayBiorreactor[i].getMaterial(),
                arrayBiorreactor[i].getEstado()
            });
        }

        jtBiorreactores.setModel(modelo);
    }//GEN-LAST:event_btnAddBiorreactorActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionBiorreactor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionBiorreactor().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAddBiorreactor;
    ...
    private javax.swing.JTable jtBiorreactores;
