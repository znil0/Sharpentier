...
public class GestionEnzima extends javax.swing.JFrame {

    public GestionEnzima() {
        initComponents();
        setLocationRelativeTo(null); //Centrar
        jtEnzimas.setModel(new Enzima().generateDTModelTemplate());
    ...
    private void initComponents() {
        ...
        jtEnzimas = new javax.swing.JTable();
        btnAddEnzima = new javax.swing.JButton();
        ...
        btnGestionEnzimas.setForeground(new java.awt.Color(160, 86, 233));
        ...
        jtEnzimas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtEnzimas);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 670, 400));

        btnAddEnzima.setText("Añadir Enzima");
        btnAddEnzima.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddEnzimaActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddEnzima, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 120, -1));
    ...
    private void btnAddEnzimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEnzimaActionPerformed
        Instanciador objInst = new Instanciador();

        int cantObj = Integer.parseInt(showInputDialog("¿Cuántas Enzimas desea añadir?"));

        Enzima[] arrayEnzima = new Enzima[cantObj];

        for(int i = 0; i < cantObj; i++){
            arrayEnzima[i] = objInst.instanciarEnzima(i+1);
        }

        DefaultTableModel modelo = new Enzima().generateDTModelTemplate();

        for(int i = 0; i < cantObj; i++){
            modelo.addRow(new Object[]{
                arrayEnzima[i].getIdEnzima(),
                arrayEnzima[i].getNombreEnzima(),
                arrayEnzima[i].getTipoEnzima()
            });
        }

        jtEnzimas.setModel(modelo);
    }//GEN-LAST:event_btnAddEnzimaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionEnzima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionEnzima().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAddEnzima;
    ...
    private javax.swing.JTable jtEnzimas;
