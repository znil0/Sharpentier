...
public class GestionMedio extends javax.swing.JFrame {

    public GestionMedio() {
        initComponents();
        setLocationRelativeTo(null); //Centrar
        jtMedios.setModel(new Medio().generateDTModelTemplate());
    ...
    private void initComponents() {
        ...
        jtMedios = new javax.swing.JTable();
        btnAddMedios = new javax.swing.JButton();
        ...
        btnGestionMedio.setForeground(new java.awt.Color(160, 86, 233));
        ...
        jtMedios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtMedios);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 670, 400));

        btnAddMedios.setText("Añadir Medio");
        btnAddMedios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddMediosActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddMedios, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 120, -1));
    ...
    private void btnAddMediosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddMediosActionPerformed
        Instanciador objInst = new Instanciador();

        int cantObj = Integer.parseInt(showInputDialog("¿Cuántos Medios desea añadir?"));

        Medio[] arrayMedio = new Medio[cantObj];

        for(int i = 0; i < cantObj; i++){
            arrayMedio[i] = objInst.instanciarMedio(i+1);
        }

        DefaultTableModel modelo = new Medio().generateDTModelTemplate();

        for(int i = 0; i < cantObj; i++){
            modelo.addRow(new Object[]{
                arrayMedio[i].getIdMedio(),
                arrayMedio[i].getComposicion(),
                arrayMedio[i].getPHMedio(),
                arrayMedio[i].getTemperatura()
            });
        }

        jtMedios.setModel(modelo);
    }//GEN-LAST:event_btnAddMediosActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionMedio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionMedio().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnAddMedios;
    ...
    private javax.swing.JTable jtMedios;
